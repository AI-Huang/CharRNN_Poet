#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Date    : Mar-07-22 11:49
# @Author  : Kelley Kan HUANG (kan.huang@connect.ust.hk)
# @RefLink : https://github.com/chenyuntc/pytorch-book/blob/master/chapter09-neural_poet_RNN/data.py
...
def get_data(opt):
    ...
    data = _parseRawData(opt.author, opt.constrain,
                         opt.data_path, opt.category)
